...
var App = function() {
    ...
    /*
     * cookie check, if no cookie, container style will be add login-status to class, 
     * if logins, class login-status wiil be removed;
     * created by Jack.H
    */
    var loginClassInit = function() {

        // console.log(jQuery.cookie('fs_operation'));
        if (jQuery.cookie(g.cookie) == undefined) {
...
var g = {
    ...
    cookieChk: function() {
        ...
        var cookieVal = jQuery.cookie(this.cookie);
